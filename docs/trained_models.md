...
| [cryosiam_denoising_aretomo3_included.ckpt](https://huggingface.co/frosinastojanovska/cryosiam_v1.0/blob/main/cryosiam_denoising_aretomo3_included.ckpt) | Denoising                   | Denoising               | Self-supervised denoising model trained on simulated WBP tomograms from IMOD and AreTomo3.                              |                                                                                                           
